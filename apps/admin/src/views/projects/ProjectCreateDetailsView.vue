  ...
  <AppShell>
    <section class="data-page">
      ...
      <div class="project-create-layout">
        ...
        <label
          class="form-field project-create-details__group project-create-details__group--first"
        >
        ...
        <div class="form-field project-create-details__group">
          ...
          <p v-if="isFiltersLoading" class="project-filter-settings__message">Загрузка настроек…</p>
          ...
          <div v-else-if="projectDimensions.length > 0" class="project-filter-settings__grid">
            ...
            >
              <div class="project-filter-settings__field-heading">
                ...
                <span v-if="dimension.selection_mode === 'multiple'">Можно выбрать несколько</span>
              </div>
        ...
        <label class="form-field project-create-details__group project-create-details__group--last">
