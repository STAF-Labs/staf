...
use App\Http\Controllers\Api\Admin\Project\ProjectReleaseController;
...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::patch('/projects/{project}/screenshots/order', [ProjectController::class, 'reorderScreenshots']);
    Route::delete('/projects/{project}/screenshots/{media}', [ProjectController::class, 'destroyScreenshot']);
