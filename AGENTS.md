...
- Do not add package names to queries because package info is already shared. Use `test resource table`, not package-specific phrasing, because package info is already shared.
